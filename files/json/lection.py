...
Это единый текстовый формат данных, был создан для хранения и передачи данных между сервисами
<>.json - файл в формата JSON
'''
...
Сериализация (запись даныых в JSON) - Это перевод из Python в JSON формат

dump - записывает данных в файл формата JSON
...
# loads - Это функция считывает данные из текста JSON 
